...
class SpotifyAuthController extends ChangeNotifier {
  ...
  Future<void> loadTracksForPlaylist(
    ...
    try {
      ...
      final resolvedPageSize = pageSize.clamp(1, 50);
      final firstPage = await _fetchPlaylistTracksPage(
        'https://api.spotify.com/v1/playlists/$realId/tracks?limit=$resolvedPageSize&offset=0',
        startIndex: 0,
      );
  ...
  Future<void> ensureAllTracksLoadedForPlaylist(
    ...
    while (hasMoreTracksForPlaylist(playlistId)) {
      await loadMoreTracksForPlaylist(
        playlistId,
        targetBpm: targetBpm,
        minBpm: minBpm,
        maxBpm: maxBpm,
